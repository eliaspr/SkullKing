...
public enum Card {
    ...
    public static class PlayedCard {
        ...
        public PlayedCard(Player player, Card card, ScaryMaryMode scaryMaryMode) {
            this.player = player;
            this.card = card;
            this.scaryMaryMode = card == SCARY_MARY ? scaryMaryMode : null;
        }

        public boolean isFlag() {
            return card == FLAG || (card == SCARY_MARY && scaryMaryMode == ScaryMaryMode.PLAY_AS_FLAG);
        }
